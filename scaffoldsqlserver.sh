...
wait
sleep 3
echo "Finally, adding SqlServer EntityFrameworkCore Provider/Connector..."
echo ""
...
dotnet ef dbcontext scaffold "Server=localhost;Database="$1";Uid="$2";Pwd="$3";" Microsoft.EntityFrameworkCore.SqlServer --context-dir Data --output-dir Models
wait
sleep 3
